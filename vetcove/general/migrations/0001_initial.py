    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('howdidyouhear', models.CharField(blank=True, null=True, max_length=200, choices=[('conference', 'Conference'), ('personal_referral', 'Personal Referral'), ('google', 'Google'), ('emailmarketing', 'Email Marketing')])),
            ],
            options={
                'abstract': False,
            },
